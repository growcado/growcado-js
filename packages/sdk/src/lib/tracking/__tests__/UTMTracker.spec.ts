...
describe('UTMTracker', () => {
  ...
  describe('initialization with UTM tracking enabled', () => {
    it('should extract and store UTM parameters', () => {
      windowMock.location.search = '?utm_source=google&utm_medium=cpc&utm_campaign=test';
    ...
    it('should handle URL encoded UTM parameters', () => {
      windowMock.location.search = '?utm_source=google%20ads&utm_medium=cpc&utm_campaign=test%20campaign';
      ...
      const storedParams = storageManager.getItem('cxp_utm_params');
      expect(storedParams).toBe('source=google%20ads&medium=cpc&campaign=test%20campaign');
    });

    it('should filter out non-UTM parameters', () => {
      windowMock.location.search = '?utm_source=google&other_param=value&utm_medium=cpc&random=test';
    ...
    it('should handle all standard UTM parameters', () => {
      windowMock.location.search = '?utm_source=google&utm_medium=cpc&utm_campaign=test&utm_term=keyword&utm_content=ad';
      ...
      const storedParams = storageManager.getItem('cxp_utm_params');
      expect(storedParams).toBe('source=google&medium=cpc&campaign=test&term=keyword&content=ad');
    });
    ...
    it('should handle special characters in UTM values', () => {
      windowMock.location.search = '?utm_source=google&utm_campaign=test!@#$%^&*()_+';
  ...
  describe('getHeaders', () => {
    ...
    it('should return empty headers when UTM tracking is disabled', () => {
      // Reinitialize with UTM disabled
      utmTracker.initialize({
        tenantId: 'test-tenant',
        enableAutoUTM: false
      }, storageManager);
  ...
  describe('URL parsing edge cases', () => {
    ...
    it('should handle duplicate UTM parameters', () => {
      windowMock.location.search = '?utm_source=google&utm_source=facebook&utm_medium=cpc';
